...
public class Product {
	...
	@Id
	@GeneratedValue
	@ApiModelProperty(notes = "The ID of the product, this is autogenerated")
	private Long id;
	@JsonProperty(required = true)
	@ApiModelProperty(notes = "The SKU of the product", required = true)
	private String sku;
	@ApiModelProperty(notes = "The Name of the product, String")
	private String name;
